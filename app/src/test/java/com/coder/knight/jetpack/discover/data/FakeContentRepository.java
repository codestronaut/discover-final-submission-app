package com.coder.knight.jetpack.discover.data;
...
public class FakeContentRepository {
    private volatile static FakeContentRepository INSTANCE = null;

    private final RemoteRepository remoteRepository;
    private final LocalRepository localRepository;

    public FakeContentRepository(@NonNull RemoteRepository remoteRepository, @NonNull LocalRepository localRepository) {
        this.remoteRepository = remoteRepository;
        this.localRepository = localRepository;
    }

    public static FakeContentRepository getInstance(RemoteRepository remoteRepository, LocalRepository localRepository) {
        if (INSTANCE == null) {
            synchronized (FakeContentRepository.class) {
                if (INSTANCE == null) {
                    INSTANCE = new FakeContentRepository(remoteRepository, localRepository);
                }
            }
        }
