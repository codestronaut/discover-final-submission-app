...
public class DummyData {
    ...
    public static List<Movie> generateFavoriteMovie() {
        List<Movie> movies = new ArrayList<>();
        Movie movie = new Movie();
        movie.setMovieId(429617);
        movie.setMovieTitle("Spider-Man: Far from Home");
        movie.setMovieDate("2019-07-02");
        movie.setMoviePopularity("393.51");
        movie.setMoviePoster("/lcq8dVxeeOqHvvgcte707K0KVx5.jpg");
        movie.setMovieRating(7.7);
        movies.add(movie);
        return movies;
    }

    public static List<TvShow> generateFavoriteTvShow() {
        List<TvShow> tvShows = new ArrayList<>();
        TvShow tvShow = new TvShow();
        tvShow.setTvId(62286);
        tvShow.setTvTitle("Fear the Walking Dead");
        tvShow.setTvDate("2015-08-23");
        tvShow.setTvPopularity("263.904");
        tvShow.setTvPoster("/lZMb3R3e5vqukPbeDMeyYGf2ZNG.jpg");
        tvShow.setTvRating(6.2);
        tvShows.add(tvShow);
        return tvShows;
    }
}
