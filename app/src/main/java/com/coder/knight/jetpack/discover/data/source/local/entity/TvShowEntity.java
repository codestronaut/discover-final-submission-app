...
public class TvShowEntity implements Parcelable {
    ...
    public TvShowEntity(int tvId, String tvTitle, String tvPopularity, int tvVoted, double tvRating, String tvDate, String tvPoster, String tvBackdrop, String tvLanguage, String tvDescription, List<GenreEntity> genres) {
        this.tvId = tvId;
